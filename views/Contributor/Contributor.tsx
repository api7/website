  ...
  return (
    <SWrapper>
      ...
      <div className="iframeBox">
        ...
        <iframe src={`https://contributor-graph-git-activity-line-apiseven.vercel.app/?chart=${chart}&repo=${repo}`} scrolling="no" style={{ overflow: "hidden", height: '1000px' }}></iframe>
      </div>
    </SWrapper>
  );
};
